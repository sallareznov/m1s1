...
/**
 * Cette classe contient les toutes les methodes dont on souhaite mesurer les
 * performances. Ces methodes s'appliquent sur un objet ArrayList ou tableau.
 */
...
public class Methodes {
	...
	/**
	 * teste la presence de e dans L en utilisant la methode contains
	 */
	...
	/**
	 * teste la presence de e dans T en utilisant une recherche sequentielle
	 */
	...
	/**
	 * recherche de la valeur du minimum de L en utilisant la methode min de la
	 * classe Collections
	 */
	...
	/**
	 * recherche de la valeur du minimum de T en utilisant une recherche
	 * séquentielle
	 */
	...
	/**
	 * recherche de la valeur du minimum de L en triant L grace a la methode
	...
	/**
	 * recherche de la valeur du minimum de T en triant T grace a la methode
